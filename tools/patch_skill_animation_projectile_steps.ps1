...
$dataPath = 'Assets/Scripts/Battle/Animation/SkillAnimationData.cs'
$playerPath = 'Assets/Scripts/Battle/Animation/SkillAnimationPlayer.cs'

if (!(Test-Path $dataPath)) { throw "Required file not found: $dataPath" }
...
Write-Host 'Patched skill animation data/player with projectile step support.'
